...
import 'package:angkot_ku/authentication/register_layout_bug.dart';
import 'package:angkot_ku/constant.dart';
import 'package:flutter/material.dart';

import '../client/ApiClient.dart';

class LoginLayoutBug extends StatefulWidget {
  const LoginLayoutBug({
    super.key,
  ...
  @override
  State<LoginLayoutBug> createState() => LoginLayoutStateBug();
}

class LoginLayoutStateBug extends State<LoginLayoutBug>{
  @override
